...
## Purpose
Defines the selection query API for molvis, enabling programmatic access to selected atoms and bonds from Python. Supports interactive workflows where users select entities in the visualization and query their metadata for further analysis or manipulation.
## Requirements
