import { EventState, Scene, Vector2 } from '@babylonjs/core';
import { 
...
export class ContextMenu {
    ...
    constructor(scene: Scene) {
        this.scene = scene;
        this.advancedTexture = AdvancedDynamicTexture.CreateFullscreenUI("ContextMenu", true, this.scene);
        ...
        this.container.onPointerDownObservable.add((evt: Vector2WithInfo, evtState: EventState) => {
