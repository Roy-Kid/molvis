import { type AbstractMesh, type Mesh, Vector3 } from "@babylonjs/core";
 ...
 */
export function getPositionFromMatrix(
  buffer: Float32Array,
  thinIndex: number,
): Vector3 {
 ...
 */
export function isThinInstanceMesh(
  mesh: Mesh,
  sceneIndex?: SceneIndex,
): boolean {
 ...
 */
export function getThinInstanceIndex(
  mesh: Mesh,
