...
- [multi-source-overlay-02-edge](multi-source-overlay-02-edge.md) — approved — pipeline reference-edge (referencedIds) + frameCache branch-aware executor + set_references RPC
