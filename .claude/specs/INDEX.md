...
- [data-source-synthesis-02-acquisition](data-source-synthesis-02-acquisition.md) — approved — re-axis DataSourceModifier to acquisition kind (FileDataSource/MemoryDataSource, each owns a Trajectory); retire FrameDataSource; keep Phase A green
- [data-source-synthesis-03-synthesis-core](data-source-synthesis-03-synthesis-core.md) — approved — pure scene_synthesis.ts: synthesize(sources, frameIndex, config) extend/augment + broadcast/zip/error + source_id + optional Kabsch
- [data-source-synthesis-04-pipeline-integrate](data-source-synthesis-04-pipeline-integrate.md) — approved — PIVOT: replace Phase A with head synthesis → single System; remove reference-edge + CombineSystems node in one mergeable commit
