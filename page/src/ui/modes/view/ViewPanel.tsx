...
export const ViewPanel: React.FC<ViewPanelProps> = ({ app }) => {
  return (
    ...
    >
      <div className="border-b px-2 py-1.5 bg-muted/10 shrink-0">
        <TabsList className="w-full grid grid-cols-2 h-7 p-0.5">
          <TabsTrigger value="pipeline" className="text-[11px] px-1.5 py-0.5">
            Pipeline
          </TabsTrigger>
          <TabsTrigger value="render" className="text-[11px] px-1.5 py-0.5">
            Render
          </TabsTrigger>
        </TabsList>
      </div>
