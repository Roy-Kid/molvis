...
import { Molvis, ModeType } from '@molvis/core';
  ...
  return (
    <div className="flex flex-col gap-6 p-4 h-full pointer-events-auto">
      ...
      <div className="space-y-3">
        <Label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Draw Element</Label>
        <Select 
            value={activeElement} 
      ...
      <div className="space-y-3">
         <Label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Bond Order</Label>
            ...
            {[1, 2, 3].map((order) => (
              <Button
                ...
                className={cn(
                    ...
                    activeBondOrder === order && "ring-2 ring-primary ring-offset-2 ring-offset-background"
                )}
